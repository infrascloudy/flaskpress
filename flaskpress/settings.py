...
"""
# from flaskpress.utils.settings import get_password
...
"""
CORE_EXTENSIONS = [
    'flaskpress.ext.cache.configure',
    'flaskpress.ext.babel.configure',
    'flaskpress.ext.generic.configure',
    'flaskpress.ext.mail.configure',
    'flaskpress.ext.error_handlers.configure',
    'flaskpress.core.db.db.init_app',
    'flaskpress.ext.themes.configure',
    'flaskpress.ext.context_processors.configure',
    'flaskpress.ext.template_filters.configure',
    'flaskpress.ext.security.configure',
    'flaskpress.ext.fixtures.configure',
    # 'flaskpress.ext.blueprints.load_from_packages',
    'flaskpress.ext.blueprints.load_from_folder',
    'flaskpress.ext.weasyprint.configure',
    'flaskpress.core.admin.configure_admin',
    'flaskpress.ext.development.configure',
    'flaskpress.ext.before_request.configure',
    'flaskpress.ext.views.configure',
    'flaskpress.ext.oauthlib.configure',
]
...
"""
Blueprints are flaskpress-modules, you don't need to install
...
"""
ADMIN = {'name': 'Flaskpress Admin', 'url': '/admin'}

"""
File admin can expose folders, you just need to have them
mapped in your server or in flask, see flaskpress.ext.views
"""
...
"""
Flaskpress-Themes checks `THEME_PATHS` configuration variable to find
