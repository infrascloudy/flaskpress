...
from flaskpress.utils.atom import AtomFeed
...
from flaskpress.utils import is_accessible, get_current_user
...
class ContentDetail(MethodView):
    ...
    def get_context(self, long_slug, render_content=False):
        ...
        if long_slug.startswith(homepage.slug) and \
            ...
            return redirect(url_for('flaskpress.core.detail', long_slug=slug))
