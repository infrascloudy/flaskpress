...
from flaskpress.core.tests import BaseTestCase
from flaskpress.ext.commands_collector import CommandsCollector


class TestCommandsCollector(BaseTestCase):

    @patch('flaskpress.ext.commands_collector.os.walk')
    @patch('flaskpress.ext.commands_collector.os.listdir')
    @patch('flaskpress.ext.commands_collector.importlib.import_module')
