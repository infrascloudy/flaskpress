...
from flaskpress.core.fields import MultipleObjectsReturned
from flaskpress.core.models.custom_values import HasCustomValue
from flaskpress.core.models.signature import Publishable, ContentFormat, Dated, Slugged
...
class Flaskpress(Dated, Slugged, db.DynamicDocument):
