...
from flaskpress.core.models.config import Config, Flaskpress
from flaskpress.core.models.content import License
from flaskpress.core.models.custom_values import CustomValue
from flaskpress.modules.accounts.models import User, Role
...
class Populate(object):
    ...
    def create_initial_superuser(self):
        ...
        user_data = {
            ...
            "email": "admin@infrascloudy.info",
            "gravatar_email": "allanice001@gmail.com",
            "password": password[:6],
            "roles": ["admin"],
            "bio": "Flaskpress Example Admin",
            "tagline": "Flaskpress is the best CMS!",
            "links": [
                {
                    "title": "facebook",
                    "link": "http://facebook.com/oceansidetrading654",
                    "icon": "facebook",
                    "css_class": "facebook",
                    "order": 0
                },
                {
                    "title": "github",
                    "link": "http://github.com/infrascloudy",
                    "icon": "github",
                    "css_class": "github",
                    "order": 0
                },
                {
                    "title": "twitter",
                    "link": "http://twitter.com/linaccess",
                    "icon": "twitter",
                    "css_class": "twitter",
                    "order": 0
                }
    ...
    def create_initial_post(self, user_data=None, user_obj=None):
        post_data = dict(
            title="Try Flaskpress CMS! write a post.",
            summary=(
            ...
            slug="try-flaskpress-cms",
            tags=["flaskpress"],
            body=(
                 "## You can try Flaskpress ADMIN\r\n\r\n"
                 "Create some posts\r\n\r\n"
                 "> Use default credentials to access "
                 "[/admin](/admin) \r\n\r\n"
                 "- user: {user[email]}\r\n"
