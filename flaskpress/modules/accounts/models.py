...
from flaskpress.utils.text import abbreviate, slugify
from flask_security import UserMixin, RoleMixin
from flask_security.utils import encrypt_password
from flask_gravatar import Gravatar
from flaskpress.modules.accounts.utils import ThemeChanger
...
class User(db.DynamicDocument, ThemeChanger, HasCustomValue, UserMixin):
    ...
    def get_avatar_url(self, *args, **kwargs):
        if self.use_avatar_from == 'url':
            ...
            return url_for(
                'flaskpress.core.media', filename=self.avatar_file_path
            )
