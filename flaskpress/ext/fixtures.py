# coding: utf-8
from flaskpress.utils.populate import Populate
from flaskpress.core.models.config import Flaskpress
...
def configure(app, db):
    ...
    try:
        is_installed = Flaskpress.objects.get(slug="is_installed")
    ...
    if not is_installed:
        ...
        try:
            ...
            Flaskpress.objects.create(slug="is_installed")
